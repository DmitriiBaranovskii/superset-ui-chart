...
class SuperChart extends _react.default.PureComponent {
  constructor() {
    ...
    _defineProperty(this, "parseDimension", (0, _reselect.createSelector)((_ref) => {
      let {
        width
      } = _ref;
      return width;
      ...
      const BoundingBox = widthInfo.isDynamic && heightInfo.isDynamic && widthInfo.multiplier === 1 && heightInfo.multiplier === 1 ? _react.default.Fragment : (_ref3) => {
        let {
          children
        } = _ref3;
  ...
  renderChart(width, height) {
    ...
    if (queryData == null || queryData.data === null || Array.isArray(queryData.data) && queryData.data.length === 0) {
      chart = _react.default.createElement(_NoResultsComponent.default, {
        id: id,
        className: className,
        height: height,
        width: width
      ...
      const chartWithoutWrapper = _react.default.createElement(_SuperChartCore.default, {
        ref: this.setRef,
        id: id,
        className: className,
        chartType: chartType,
      ...
      chart = Wrapper ? _react.default.createElement(Wrapper, {
        width: width,
        height: height
    ...
    return disableErrorBoundary === true ? chart : _react.default.createElement(_reactErrorBoundary.default, {
      FallbackComponent: props => _react.default.createElement(_FallbackComponent, _extends({
        width: width,
        height: height
      }, props)),
  ...
  render() {
    ...
    if (widthInfo.isDynamic || heightInfo.isDynamic) {
      ...
      return _react.default.createElement(BoundingBox, null, _react.default.createElement(_responsive.ParentSize, {
